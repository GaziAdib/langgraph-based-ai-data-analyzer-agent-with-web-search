...
def create_workflow() -> Graph:
    ...
    # Setting our entry point
    workflow.set_entry_point("router")
    
    # Adding conditional edges Based on Our Conditions
    ...
    # Adding edges for our Graph Nodes
...
def main():
    ...
    if st.session_state.documents:
        ...
        # Adding document management in sidebar
