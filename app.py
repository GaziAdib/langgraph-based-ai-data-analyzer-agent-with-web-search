...
st.title("📄Advanced Document Analysis Agent")
...
# # Add custom CSS for better streaming appearance
# st.markdown("""
# <style>
#     .streaming {
...
# def stream_response(text: str, speed: float = 0.02) -> Generator[str, None, None]:
#     """Simulate streaming by yielding words one at a time with natural pacing."""
#     words = text.split(' ')
...
# def typewriter_effect(text: str, speed: int = 30) -> Generator[str, None, None]:
#     """Create a typewriter effect by yielding characters one at a time."""
...
#                     for chunk in typewriter_effect(response, speed=30):
#                         message_placeholder.markdown(chunk + " <span class='typing-cursor'>|</span>", unsafe_allow_html=True)
